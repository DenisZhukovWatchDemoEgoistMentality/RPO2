...
BucketWithBolts - консольный проект, в котором находятся:
 1. База данных.
 2. Модели бд и таблиц.
 3. Роутеры с методами для создания, получения (всех или одно) и удаления из таблиц.
